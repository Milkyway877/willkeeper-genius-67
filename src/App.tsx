...
// Add these imports for the new executor pages
import ExecutorLogin from '@/pages/executor/ExecutorLogin';
import ExecutorPinVerification from '@/pages/executor/ExecutorPinVerification';
import ExecutorDocuments from '@/pages/executor/ExecutorDocuments';
import ExecutorExpired from '@/pages/executor/ExecutorExpired';
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* New executor portal routes */}
        <Route path="/executor" element={<ExecutorLogin />} />
        <Route path="/executor/verify/:sessionId" element={<ExecutorPinVerification />} />
        <Route path="/executor/documents/:sessionId" element={<ExecutorDocuments />} />
        <Route path="/executor/expired" element={<ExecutorExpired />} />
