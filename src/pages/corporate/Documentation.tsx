  ...
  const documentationCategories = [
    {
      ...
      link: "/corporate/documentation/getting-started"
    },
    {
      title: "User Guides",
      ...
      link: "/corporate/documentation/user-guides"
    },
    {
      title: "API Reference",
      ...
      link: "/corporate/documentation/api"
    },
    {
      title: "Data Security",
      ...
      link: "/corporate/documentation/security"
    },
    {
      title: "Integrations",
      ...
      link: "/corporate/documentation/integrations"
    }
  ];
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { title: "Creating Your First Will", views: "5.2k", difficulty: "Beginner", time: "10 min read", link: "/corporate/documentation/getting-started#first-will" },
                  { title: "Setting Up Executor Access", views: "3.8k", difficulty: "Intermediate", time: "15 min read", link: "/corporate/documentation/user-guides#executors" },
                  { title: "Digital Asset Management", views: "2.9k", difficulty: "Intermediate", time: "12 min read", link: "/corporate/documentation/user-guides#digital-assets" },
                  { title: "Estate Planning for Business Owners", views: "2.5k", difficulty: "Advanced", time: "20 min read", link: "/corporate/documentation/user-guides#business-owners" },
                  { title: "API Authentication", views: "1.8k", difficulty: "Technical", time: "8 min read", link: "/corporate/documentation/api#authentication" }
                ].map((doc, index) => (
            ...
            >
              ...
              <div className="mt-6">
                <Link to="/corporate/documentation/updates" className="text-willtank-600 hover:text-willtank-700 font-medium inline-flex items-center">
