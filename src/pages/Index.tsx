  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <motion.section
          id="business"
          className="py-16 xs:py-20 sm:py-24 bg-white relative overflow-hidden"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className="container max-w-6xl px-4 md:px-6 relative z-10">
            ...
            >
              <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-bold mb-4 xs:mb-6 tracking-tight text-black">
                Enterprise Solutions
              </h2>
              <p className="text-lg xs:text-xl text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 xs:gap-8">
              {[
                ...
                <motion.div 
                  key={index}
                  className="rounded-xl bg-white border border-gray-200 p-4 xs:p-6 hover-lift"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: item.delay }}
                >
                  <div className="h-10 w-10 xs:h-12 xs:w-12 rounded-full bg-black flex items-center justify-center mb-3 xs:mb-4">
                    {React.cloneElement(item.icon, { className: "h-5 w-5 xs:h-6 xs:w-6 text-white" })}
                  </div>
                  <h3 className="text-lg xs:text-xl font-bold mb-2 xs:mb-3 text-black">{item.title}</h3>
                  <p className="text-gray-700 mb-3 xs:mb-4 text-sm xs:text-base">{item.description}</p>
                  <Link to="/business">
                    <Button variant="ghost" size="sm" className="text-black hover:text-black hover:bg-black/5 p-0 h-auto min-h-touch">
        ...
        <motion.section
          id="how-it-works"
          className="py-16 xs:py-20 sm:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
            ...
            <div className="max-w-4xl mx-auto">
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl xs:text-2xl font-bold mb-3 xs:mb-4 text-black">{step.title}</h3>
                        <p className="text-gray-700 text-base xs:text-lg">{step.description}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
              ...
              >
                <Link to="/how-it-works">
                  <Button className="bg-black hover:bg-gray-800 text-white rounded-full px-6 xs:px-8 py-4 xs:py-6 text-base xs:text-lg min-h-touch">
