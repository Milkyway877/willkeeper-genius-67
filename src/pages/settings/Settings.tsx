            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-2">
                <Tabs orientation="vertical" value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="flex flex-col items-stretch h-auto bg-transparent border-none p-0">
                    <TabsTrigger 
                      value="account" 
                      className="justify-start mb-1 data-[state=active]:bg-willtank-50 data-[state=active]:text-willtank-700 rounded-lg"
                    >
