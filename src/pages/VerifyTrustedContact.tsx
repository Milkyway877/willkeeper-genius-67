          ...
          <div className="space-y-6">
            <Alert variant="default" className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription>
                ...
                No action is required from you unless explicitly stated in the email.
              </AlertDescription>
            </Alert>
            ...
            <div className="bg-green-50 rounded-lg p-6 text-center border border-green-100">
              ...
              <h3 className="text-lg font-medium mb-2">Successfully Added</h3>
              <p className="text-gray-600 mb-4">
                You have been successfully added as a trusted contact. You will receive 
