      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-4 max-w-sm w-full border border-gray-200 dark:border-gray-700 flex flex-col"
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto mb-4">
              {response && (
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md mb-2 text-sm">
